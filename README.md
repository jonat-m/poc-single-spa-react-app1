...
This repository contains `react-app1`, microfrontend que combina os repositories `react-parcel` e `utils`, sendo ambos frontends agindo ao mesmo tempo, e o utils apenas servindo funções
